...
INSERT INTO val_double_rules (identifier, description, maximum_value, minimum_value) VALUES (1000, 'Decimal degrees (DD) is a notation for expressing latitude and longitude geographic coordinates as decimal fractions of a degree.', 90.0, -90.0);
...
INSERT INTO val_double_rules (identifier, description, maximum_value, minimum_value) VALUES (1001, 'Decimal degrees (DD) is a notation for expressing latitude and longitude geographic coordinates as decimal fractions of a degree.', 180.0, -180.0);
...
INSERT INTO val_double_rules (identifier, description, maximum_value, minimum_value) VALUES (2000, 'Speed over Ground, measured in knots', 10000, -100);
INSERT INTO single_field_def (name, acronym, description, double_rule_identifier) VALUES ('Speed Over Ground', 'SOG', 'Speed over Ground (SOG) is the vessels speed in one hour concerning the land or any other fixed object such as buoys.', 2000);
