...
public class MultiValidationRuleFieldDefinitionDomain extends AbstractFieldDefinitionDomain
   ...
   */
  public MultiValidationRuleFieldDefinitionDomain(final String acryo, final Collection<Category> cats,
                                                  final String desc,
